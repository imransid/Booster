...
class AddNewWallet extends Component {
  ...
  ADD_New_Wallet = () => {
    if (
      ...
      this.state.balance == "" &&
      this.state.balance_type == "" &&
      this.state.card_num == ""
    ) {
      ToastAndroid.show(
        "Please Cheak Again Cann't Save Empty Field",
        ToastAndroid.SHORT
      );
    } else {
      let data = {
      ...
      <View style={{ flex: 1, backgroundColor: "#FFF" }}>
        ...
        <ScrollView style={{ padding: 10 }}>
          ...
          >
              ...
              <View>
                <Input
                  onChangeText={card_holder_name =>
                    this.setState({ card_holder_name })
                  }
                  placeholder="Enter Name"
                  placeholderTextColor="#304FFE"
                  style={{ width: "100%", color: "#304FFE" }}
                />
              </View>
            </View>
            <View style={styles.CardBlockSyle}>
              ...
              <View style={{ width: "50%", height: "100%" }}>
                <Picker
                  ...
                  onValueChange={itemValue =>
                    this.setState({ bank_code: itemValue })
                  }
                >
            ...
            <View style={styles.CardBlockSyle}>
              <View style={styles.CardTextSyle}>
                <Text style={styles.CardText}>Balance Type</Text>
              </View>
              <View style={{ width: "50%", height: "100%" }}>
                <Picker
                  style={{ color: "#304FFE" }}
                  ...
                  onValueChange={itemValue =>
                    this.setState({ balance_type: itemValue })
                  }
                >
            ...
            <View style={styles.CardBlockSyle}>
              ...
              <View>
                <Input
                  ...
                  placeholder="Enter Card Last 4 Degit"
                  placeholderTextColor="#304FFE"
                  style={{ width: "100%", color: "#304FFE" }}
                />
              </View>
            ...
            >
              ...
              <View style={{ width: "70%", alignItems: "center" }}>
                <TouchableHighlight
                  style={styles.defaultButtonTransection}
                  onPress={() => this.ADD_New_Wallet()}
                >
                  <View style={{ flexDirection: "row" }}>
                    <ENTYPO_ICON name="plus" size={18} color="#fff" />
